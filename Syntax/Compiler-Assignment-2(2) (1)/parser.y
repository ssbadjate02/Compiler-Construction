...
%type <nPtr> iteration_statement expr_or_assignment translation_unit statement_list declaration_list declaration_statment_list
...
%left ',' 
%right '=' MUL_ASSIGN DIV_ASSIGN MOD_ASSIGN ADD_ASSIGN SUB_ASSIGN AND_ASSIGN XOR_ASSIGN OR_ASSIGN
...
jump_statement
	...
	| BREAK ';'					{$$ = opr(BREAK,0);}
	| RETURN expression_statement {$$ = opr('j',2,id("return"),$2);}
	/* | RETURN ';'				{$$ = opr(RETURN ,0);}
