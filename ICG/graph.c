	...
	*/
	...
	switch(p->type) 
	{
		...
		//	case UMINUS: s = "[_]"; break;
			...
			case EQ_OP: s = "[==]"; break;
			case ',': s="[,]";break;
			case 'a': s = "array";break;
			case 'f': s="function - args";break;
			case 'l': s="[<<]";break;
			case 'r': s="[>>]";break;
			case '^': s="[^]";break;
			case '&': s="[&&]";break;
			case '|': s="[||]";break;
			case '\n': s="[newline]";break;
			case 'g' : s = "function";break;
			case 'z' : s = "function - args types";break;
			case 'k' : s = "function - args names";break;
			case '2' : s = "2D Array";break;
			case 'y' : s = "arglist";break;
			case 'x' : s = "argslist array";break;
			case 'u' : s = "arglist2";break;
			case 's' : s= "String";break;
			case 'e' : s="end_function";break;
		}
	break;
	}
